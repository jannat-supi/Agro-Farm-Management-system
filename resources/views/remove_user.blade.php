  ...
  <div class="col col-lg-10 col-sm-12 col-12 working_div">
    <center>
      ...
      <div class="col col-lg-8 col-sm-12 col-12 offset-lg-2 border shadow" >
        <h2 class="text-black" align="center" style="margin-top: 5%; color: #FF8F2B;"><center><b>Remove Shareholder</b></center></h2>
        <br>
        ...
        <div class="col col-lg-10 col-sm-12 ">
          <form action="{{url('/delete_user') }}" method="post" >
              ...
              <div class="form-group row">
                <div class="col-sm-4">
                  <label for="id" style="font-size: 16px;"><b>Select-Shareholder:</b></label>
                </div>
                <div class="col-sm-8">
