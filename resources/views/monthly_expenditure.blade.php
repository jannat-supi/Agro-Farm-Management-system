      ...
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> 
       ...
       <div class="collapse navbar-collapse " id="navbarSupportedContent">     
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" data-value="about_us" href="add_expenditure" style="color: #FF8F2B; font-size: 18px;">Daily Expenditure</a>        
          </li>
					<li class="nav-item"> 
            <a class="nav-link " data-value="home" href="monthly_expenditure" style="color: #FF8F2B; font-size: 18px;">Monthly Expenditure</a>       
					</li>
					<li class="nav-item">
  ...
  <div class="col col-lg-10 col-sm-12 col-12 offset-lg-1 working_div">
    <center>
      ...
      <div class="col col-lg-8 col-sm-12 col-12 border shadow" >
        <h2 class="text-black" align="center" style="margin-top: 5%; color: #FF8F2B;"><center><b>Monthly Expenditure</b></center></h2>
        <br>
        ...
        <div class="col col-lg-10 col-sm-12">
          <form action="{{url('/addmonthly_expenditure') }}" method="get" >
					 <input type="hidden" name="_token" value="{{csrf_token()}}">
						<div class="form-group row">
              <div class="col-sm-4">
                <label for="buying-price" style="font-size: 16px;"><b>Date:</b></label>
              </div>
              <div class="col-sm-8">
                <input class="form-control" type="date" name="mdate" id="mdate" required>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-sm-4">
                <label for="id" style="font-size: 16px;"><b>Rent:</b></label>
              </div>
              <div class="col-sm-8">
                <input class="form-control" type="text" name="rent" id="rent" placeholder="enter rent..." required>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-sm-4">
                <label for="cow-type" style="font-size: 16px;"><b>Employee-salary:</b></label>
              </div>
              <div class="col-sm-8">
                <input class="form-control" type="text" name="employee_salary" id="employee_salary" placeholder="enter employee-salary..." required>
              </div>
            </div>
            <div class="form-group row">
