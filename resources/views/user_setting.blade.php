...
<div class="wrapper row3">
  ...
  <section class="hoc container clear"> 
	  <center>
        <a  href="add_user"><button class="btn btn-deep-orange btn-lg" style="font-size:15px"><i class="fa fa-user-plus" style="font-size:24px"></i> Add Shareholder</button></a>
	      <a  href="remove_user"><button class="btn btn-deep-orange btn-lg" style="font-size:15px"><i class="fa fa-user-times" style="font-size:24px"></i> Remove Shareholder</button></a>
	      <a  href="user_list"><button class="btn btn-deep-orange btn-lg" style="font-size:15px"><i class="fa fa-users" style="font-size:24px"></i> Shareholder-list</button></a>
	  </center>
  </section>
  <br><br><br><br>
</div>
