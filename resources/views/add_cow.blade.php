  ...
  <div class="col col-lg-10 col-sm-12 col-12 working_div">
    ...
    <center>
      <div class="col col-lg-8 col-sm-12 col-12 offset-lg-2 border shadow" style="margin-top: 5%; margin-bottom: 5%;">
        <h2 class="text-black" align="center" style="margin-top: 5%; color: #FF8F2B;"><center><b>Add Cow-Info</b></center></h2>
        <br>
        ...
        <div class="col col-lg-10 col-sm-12 offset-lg-1">
          <form method="post" action="{{url('/adding_cow') }}" enctype="multipart/form-data">
						<input type="hidden" name="_token" value="{{csrf_token()}}">
            <div class="form-group row">
              <div class="col-sm-4">
                <label for="id" style="font-size: 16px;"><b>Cow-ID:</b></label>
              </div>
              <div class="col-sm-8">
                <input class="form-control" type="text" name="id" id="cow-id" placeholder="enter cow id..." required>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-sm-4">
                <label for="cow-type" style="font-size: 16px;"><b>Cow-Type:</b></label>
              </div>
              <div class="col-sm-8">
                <input class="form-control" type="text" name="cow_type" id="cow-type" placeholder="enter cow-type..." required>
              </div>
            </div>
						<div class="form-group row">
              <div class="col-sm-4">
                <label for="cow-color" style="font-size: 16px;"><b>Cow-Color:</b></label>
              </div>
              <div class="col-sm-8">
                <input class="form-control" type="text" name="cow_color" id="cow-color" placeholder="enter cow-color..." required>
              </div>
            </div>
						<div class="form-group row">
              <div class="col-sm-4">
                <label for="buying-price" style="font-size: 16px;"><b>Buying-Price:</b></label>
              </div>
              <div class="col-sm-8">
                <input class="form-control" type="text" name="buying_price" id="buying-price" placeholder="enter cow's buying-price..." required>
              </div>
            </div>
						<div class="form-group row">
              <div class="col-sm-4">
                <label for="buying-place" style="font-size: 16px;"><b>Buying-Place:</b></label>
              </div>
              <div class="col-sm-8">
                <input class="form-control" type="text" name="buying_place" id="buying-place" placeholder="enter cow's buying-place..." required>
              </div>
            </div>
						<div class="form-group row">
              <div class="col-sm-4">
                <label for="buying-date" style="font-size: 16px;"><b>Buying-Date:</b></label>
              </div>
              <div class="col-sm-8">
                <input class="form-control" type="date" name="buying_date" id="buying-date" placeholder="enter cow's buying-date..." required>
              </div>
            </div>
						<div class="form-group row">
              <div class="col-sm-4">
                <label for="image" style="font-size: 16px;"><b>Cow-Image:</b></label>
              </div>
              <div class="col-sm-8">
            ...
            <div class="form-group row">
              <div class="col-sm-12" align="center">
                <button type="submit" class="btn text-white" name="add" style="background: #FF8F2B;">Add Cow</button>
              </div>
            </div>
            <br>
          </form>
