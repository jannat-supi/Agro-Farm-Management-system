  ...
  <div class="col col-lg-10 col-sm-12 col-12 working_div">
    <center>
      ...
      <div class="col col-lg-8 col-sm-12 col-12 offset-lg-2 border shadow" >
        <h2 class="text-black" align="center" style="margin-top: 5%; color: #FF8F2B;"><center><b>Remove Admin</b></center></h2>
        <br>
        ...
        <div class="col col-lg-10 col-sm-12 ">
          <form action="{{url('/removed_admin') }}" method="post" >
              ...
              <div class="form-group row">
                <div class="col-sm-12" align="center">
                  <button type="submit" class="btn text-white" name="remove" style="background: #FF8F2B;">Remove</button>
                </div>
              </div>
              <br>
          </form>
